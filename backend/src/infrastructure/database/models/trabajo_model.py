...
class CasoPruebaModel(Base):
    ...
    numero_requerimiento = Column(String(100), nullable=True)
    ambiente = Column(String(100), nullable=True)
    precondiciones = Column(Text, nullable=True)
    datos_prueba = Column(Text, nullable=True)
...
class CasoPruebaItemModel(Base):
    ...
    severidad = Column(String(50), nullable=False, default="Media")
    created_at = Column(DateTime(timezone=True), server_default=func.now())
